        ...
        <div className="bg-gray-800 rounded-lg shadow-lg overflow-hidden">
          <div className="md:flex">
            <div className="md:flex-shrink-0">
              <img className="h-48 w-full object-cover md:w-48" src={doctorProfile?.image as any} alt={`${doctorProfile?.firstName} ${doctorProfile?.lastName}`} />
            </div>
            <div className="p-8">
              ...
              <div className="mt-2 flex items-center text-gray-400">
                ...
                {doctorProfile?.priceOneHour.price} {doctorProfile?.priceOneHour.currency} / hour
              </div>
            </div>
          </div>
